...
// - Change CTabbedFrameImpl::UpdateLayout to use new CalculateBounds.
//
// 2005/12/19: Pascal Binggeli
// - Add CCustomTabOwnerImpl::SetImageSize
//
// 2005/09/10: Daniel Bowen
// - Fix type mis-match warning.
//
...
public:
	...
	void KeepTabsHidden(bool bKeepTabsHidden = true)
	{
		if(m_bKeepTabsHidden != bKeepTabsHidden)
		{
			...
			// Derived classes should override and force an appropriate
...
public:
	...
	void UpdateLayout(BOOL bResizeBars = TRUE)
	{
		...
		// No need to UpdateLayout here.  The EndDeferWindowPos will
		// cause a SetWindowPos which will trigger a WM_SIZE.  The WM_SIZE
		// handler will do an UpdateLayout.
		//m_TabCtrl.UpdateLayout();
	}
};
