...
// Updated for new CCustomTabCtrl by Daniel Bowen (bowen.daniel@gmail.com).
...
public:
   ...
   LRESULT OnSettingChange(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
   {
      ...
      {
         // New scope for CClientDC
         CClientDC dc(m_hWnd);
         TEXTMETRIC tm = {0};
         CFontHandle oldFont = dc.SelectFont(this->GetFont());
         dc.GetTextMetrics(&tm);

         m_settings.iTabDefaultHeight = (signed char)(tm.tmHeight + tm.tmExternalLeading + 8);
 ...
 */
      ...
      m_settings.iTabDefaultHeight = (signed char)(lf.lfHeight + 4);
...
public:
   ...
   LRESULT OnSettingChange(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
   {
      ...
      m_settings.iTabDefaultHeight = (signed char)(ncm.iSmCaptionHeight + 4);
   ...
   {
      customTabClass::UpdateLayout_ScrollToFit(rcTabItemArea);
