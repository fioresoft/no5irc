...
#import "C:\Users\Fernando\source\repos\NO5TL sock clients\irc12\Redistributable\Unicode\DDForms.dll" raw_interfaces_only, raw_native_types, named_guids
...
public:
	DECLARE_FRAME_WND_CLASS(_T("NO5IRCCLSFORM"), IDR_FORMFRAME)
	...
	BEGIN_MSG_MAP(CFormFrame)
		...
		MESSAGE_HANDLER(WM_FORMVIEW,OnDeleteViewer)
		...
		//
		COMMAND_RANGE_HANDLER(ID_EDIT_CUT,ID_REDO,OnEditCmd) // TODO NAO ESTA MAIS EM RANGE
...
//	LRESULT NotifyHandler(int /*idCtrl*/, LPNMHDR /*pnmh*/, BOOL& /*bHandled*/)
	...
	//CComPtr<DDFORMSLib::IFormEditor> m_spFormEditor;
	CComPtr<DDFORMSLib::IFormEditor2> m_spFormEditor;
	//CComDispatchDriver m_spFormEditor;
	CComPtr<DDFORMSLib::IFormViewer2> m_spFormViewer;
